...
const Detail = () => {
    ...
    const cartHandler = () => {
        ...
        const cart = {
            name,type,price,description,rating,photo,userName
        }
...
<div className="bg-slate-100 space-y-4 p-4 flex-grow rounded-xl">
    ...
    <div className="text-xl flex gap-3 items-center"><span className="font-semibold">Rating: </span> <span className="flex items-center gap-2"><Rating  style={{ maxWidth: 180 }}
      value={loadedData.rating}
      readOnly></Rating> {loadedData.rating} </span></div>
